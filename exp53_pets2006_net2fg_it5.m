...
net_path = '../network/net_recursive_it3/PETS2006/';
net_path = '../network/net_recursive_it4/PETS2006/';
net_path = '../network/net_recursive_it5/PETS2006/';
...
path_save = '../detection/net2fg_it3/PETS2006/';
path_save = '../detection/net2fg_it4/PETS2006/';
path_save = '../detection/net2fg_it5/PETS2006/';
...
for i = 1:frames
	...
	if i < 300
		...
		displayMatrixImage(i,1,3,imread(fullfiles{i})  , fgim,gtim)
