...
if strcmp(mode,'train') == 1
%    labimg = scaleImage(labimg, 0.5);
%    curimg = scaleImage(curimg, 0.5);

    labimg = scaleImage_byHeight(labimg, 240);
    curimg = scaleImage_byHeight(curimg, 240);
%    im = scaleImage(im, 0.5);
end
