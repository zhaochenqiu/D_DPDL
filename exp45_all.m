...
for i = 300:frames
    ...
    for j = 1:num_bay
        fgim = bayesRefine(im, fgim, 3, 0.7);
...
txtWrite(value, 'temp_highway.txt');
...
txtWrite(value, 'temp_pedestrians.txt');
...
txtWrite(value, 'temp_office.txt');
...
txtWrite(value, 'temp_pets2006.txt');
