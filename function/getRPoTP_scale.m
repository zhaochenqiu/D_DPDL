function re_imdb = getRPoTP_scale(im_pa, im_ft, gt_pa, gt_ft, curindex, num, mode, scale)
...
% if strcmp(mode,'train') == 1
    labimg = scaleImage(labimg, scale);
    curimg = scaleImage(curimg, scale);
