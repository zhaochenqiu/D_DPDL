function [] = bgs_train(imdb,path_save)
...
if isempty(g_gpuId) ~= 1
    opts.train = struct('gpus', [g_gpuId]);
else
...
net = bgs_network_init('batchNormalization', opts.batchNormalization, ...
...
switch opts.networkType
  case 'simplenn', trainfn = @cnn_train_multi_random ;
