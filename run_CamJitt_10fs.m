...
fg_pa = '~/projects/matrix/detection/iterative/cameraJitter/boulevard_10fs/';
net_pa = '~/projects/matrix/network/iterative/cameraJitter/boulevard_10fs/';
...
fg_pa = '~/projects/matrix/detection/iterative/cameraJitter/sidewalk_10fs/';
net_pa = '~/projects/matrix/network/iterative/cameraJitter/sidewalk_10fs/';
...
fg_pa = '~/projects/matrix/detection/iterative/cameraJitter/traffic_10fs/';
net_pa = '~/projects/matrix/network/iterative/cameraJitter/traffic_10fs/';
...
fg_pa = '~/projects/matrix/detection/iterative/cameraJitter/badminton_10fs/';
net_pa = '~/projects/matrix/network/iterative/cameraJitter/badminton_10fs/';
